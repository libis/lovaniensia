...
/**
 * Copy of the original omeka Strategy for making derivatives with ImageMagick on the command line.
 * With one addition: no images created for rosetta objects be ignored since they don't need derivatives
 * 
    ...
    extends Omeka_File_Derivative_Strategy_ExternalImageMagick
{
    ...
    {
        //Rosetta plugin: don't bother making derivative files for rosetta objects
        if (strpos($sourcePath,'_resolver') !== false):
            return true;
        endif;
